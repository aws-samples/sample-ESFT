"""
Patch for Qwen3 MoE models to enable expert weight logging.

This patch modifies the Qwen3MoeSparseMoeBlock to log expert selection
and routing weights during forward passes.

Note: Qwen3 MoE does NOT have shared experts (unlike Qwen2 MoE).
"""
import os
import torch
...
def patch_qwen3_moe():
    """Patch Qwen3MoeSparseMoeBlock to log expert weights."""
    try:
        ...
        print("Warning: Qwen3MoeSparseMoeBlock not found, skipping Qwen3 MoE patch")
        return
    ...
    Qwen3MoeDecoderLayer.__init__ = patched_decoder_init
    ...
    def patched_forward(self, hidden_states):
        ...
        # Note: Qwen3 MoE does NOT have shared expert (unlike Qwen2 MoE)
        
        final_hidden_states = final_hidden_states.reshape(batch_size, sequence_length, hidden_dim)
        return final_hidden_states, router_logits
    
    Qwen3MoeSparseMoeBlock.forward = patched_forward
    print("✓ Qwen3MoeSparseMoeBlock patched successfully")
